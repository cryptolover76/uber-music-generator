...
test('parser aceita nome com espaços e preserva formato antigo', () => { assert.deepEqual(parseMusicCommand('/musica Carlos da Silva'), { passengerName: 'Carlos da Silva', gender: null }); assert.deepEqual(parseMusicCommand('/musica  João Pedro  | m'), { passengerName: 'João Pedro', gender: 'M' }); assert.deepEqual(parseMusicCommand('/musica Alex | N'), { passengerName: 'Alex', gender: 'N' }); });
